...
This heat map would be more interesting if `Info.On.Internet` were a set of factors, e.g. `Name.On.Internet`,`DOB.On.Internet` ...
...
levels(hm$Var1)=levels=paste(tt<-seq(0,90,binyears),tt+binyears,sep="-")
